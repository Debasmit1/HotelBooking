...
import { faBed, faCalendarDays, faCar, faMapPin, faPerson, faPlane, faTaxi } from '@fortawesome/free-solid-svg-icons'
        ...
        <div className='header'>
            <div className={type === "list" ? "headerContainer listMode" : "headerContainer"}>
                ...
                {type !== 'list' && <>
                    ...
                    <p className="headerDesc">Get rewarded for your travels - unclock instant savings of 10% or more with a free DebsBooking account</p>
